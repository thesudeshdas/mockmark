...
const reviewSignalStyles = `:host{font-family:Arial,sans-serif;color:#15181d}.mm-toolbar{gap:2px;padding:4px;background:#15181d;border:1px solid #303741;border-radius:4px;box-shadow:0 8px 24px #0003}.mm-toolbar button{color:#f7f9fb;border-radius:2px}.mm-toolbar button.on{background:#ffd84d;color:#15181d}.mm-pin,.mm-region{background:#ffd84d;color:#15181d;border-color:#fff;box-shadow:0 0 0 1px #15181d}.mm-region{background:#ffd84d30;border-color:#b48a00}.mm-region span{background:#ffd84d;color:#15181d}.mm-draft{border-color:#b48a00;background:#ffd84d24}.mm-panel{background:#fff;border-color:#c7cdd4;border-radius:4px;box-shadow:0 8px 24px #15181d1f}.mm-panel>p,.mm-list small,.mm-messages time,.mm-empty{color:#5c6470}.mm-panel input,.mm-panel textarea{border-color:#c7cdd4;border-radius:3px}.mm-panel input:focus,.mm-panel textarea:focus{border-color:#0a65ff;box-shadow:0 0 0 2px #fff,0 0 0 4px #0a65ff}.mm-panel .primary{border-radius:3px;background:#15181d;color:#fff}.mm-list>button,.mm-messages article{border-color:#e2e6ea}.mm-list>button>span{background:#ffd84d;color:#15181d}.mm-messages footer button,.mm-actions button{border-color:#c7cdd4;border-radius:3px}.mm-toast{background:#b42318;border-radius:3px}`;
